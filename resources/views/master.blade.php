...
<html lang="en">
    <head>
        ...
        <title>AromaCraft Roastery</title>
    ...
    <body>
        <header>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                <span class="site-heading-upper text-primary mb-3">Crafting Aromas, Elevating Moments.</span>
                <span class="site-heading-lower">AromaCraft Roastery</span>
            </h1>
        </header>
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
            <div class="container">
                <a class="navbar-brand text-uppercase fw-bold d-lg-none" href="index.html">AromaCraft Roastery</a>
